...
const A_FEATURES = [
  {
    color: "bg-red-50",
    name: "Phí vận chuyển thấp",
    desc: "Mỗi đơn hàng chỉ từ 20.000đ",
  ...
  {
    color: "bg-sky-50",
    name: "Nhanh chóng và tiện lợi",
    desc: "Chỉ cần vài thao tác đơn giản",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    desc: "Nhanh chóng, tiện lợi, an toàn",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    desc: "60 ngày hoàn trả với sản phẩm lỗi",
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
