...
import Policy from "../../product-detail-3/Policy";
import ModalViewAllReviews from "../../product-detail-3/ModalViewAllReviews";
...
import { GET_PRODUCT } from "@/api/product/endpoints";
...
const ProductDetailPage2 = ({}) => {
  ...
  useEffect(() => {
    ...
    customAxios
      ...
      .catch((err) => {
        notifyError(err?.response?.message || "Error get product");
        setTimeout(() => {
          router.back();
        }, 1000);
      });
          ...
          <div className="">
            ...
            <div className="flex items-center justify-between space-x-5">
              <div className="flex text-2xl font-semibold">
                {String(
                  product.price?.lastValue.toLocaleString("it-IT", {
                    style: "currency",
                    currency: "VND",
                  })
                )}
          ...
          <div className="hidden sm:flex flex-col space-y-4 ">
            <div className="space-y-2.5">
              <div className="flex justify-between text-slate-600 dark:text-slate-300">
                <span className="flex">
                  <span>{formatVnCurrency(product.price?.lastValue)}</span>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 lg:gap-6">
              ...
              >
                <NcImage
                  ...
                  src={renderImageCloudinary(product?.images?.at(0)?.url)}
                  fill
